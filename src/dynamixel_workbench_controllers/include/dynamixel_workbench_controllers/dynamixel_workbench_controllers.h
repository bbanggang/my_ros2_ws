...
#include "dynamixel_workbench_controllers/dynamixel_workbench.h"
...
class DynamixelController: public rclcpp::Node
{
 private:
  ...
  //trajectory_msgs::JointTrajectory *jnt_tra_;
  //trajectory_msgs::msg::JointTrajectory *jnt_tra_;
 ...
 public:
  ...
  bool initSDKHandlers(void);
    ...
    //bool getPresentPosition(std::vector<std::string> dxl_name); // for joint trajectory control
  ...
  //void trajectoryMsgCallback(const trajectory_msgs::msg::JointTrajectory::SharedPtr msg);
  //bool dynamixelCommandMsgCallback(const std::shared_ptr<dynamixel_workbench_msgs::srv::DynamixelCommand::Request> req, const std::shared_ptr<dynamixel_workbench_msgs::srv::DynamixelCommand::Response> res);
  bool dynamixelCommandMsgCallback(const std::shared_ptr<dynamixel_workbench_msgs::srv::DynamixelCommand::Request> req,
